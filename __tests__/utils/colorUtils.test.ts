...
test("rgbToHex", () => {
  expect(
    rgbToHex(bitterSweet.rgb.r, bitterSweet.rgb.g, bitterSweet.rgb.b),
  ).toBe(bitterSweet.hex);
  expect(rgbToHex(mintGreen.rgb.r, mintGreen.rgb.g, mintGreen.rgb.b)).toBe(
    mintGreen.hex,
  );
  expect(rgbToHex(darkBlue.rgb.r, darkBlue.rgb.g, darkBlue.rgb.b)).toBe(
    darkBlue.hex,
  );
  expect(rgbToHex(indochine.rgb.r, indochine.rgb.g, indochine.rgb.b)).toBe(
    indochine.hex,
  );
...
test("rgbToDecimal", () => {
  expect(
    rgbToDecimal(bitterSweet.rgb.r, bitterSweet.rgb.g, bitterSweet.rgb.b),
  ).toBe(bitterSweet.decimal);
  expect(rgbToDecimal(mintGreen.rgb.r, mintGreen.rgb.g, mintGreen.rgb.b)).toBe(
    mintGreen.decimal,
  );
  expect(rgbToDecimal(darkBlue.rgb.r, darkBlue.rgb.g, darkBlue.rgb.b)).toBe(
    darkBlue.decimal,
  );
  expect(rgbToDecimal(indochine.rgb.r, indochine.rgb.g, indochine.rgb.b)).toBe(
    indochine.decimal,
  );
  expect(rgbToDecimal(purple.rgb.r, purple.rgb.g, purple.rgb.b)).toBe(
    purple.decimal,
  );
});
